...
class phpbb_questionnaire_phpbb_data_provider
{
	...
	*/
	function phpbb_questionnaire_phpbb_data_provider($config)
	{
		...
		if (empty(phpbb::$config['questionnaire_unique_id']))
		{
		...
		{
			$this->unique_id = phpbb::$config['questionnaire_unique_id'];
		}
	...
	*/
	function get_data()
	{
		...
		include(phpbb::$phpbb_root_path . "config.$phpEx");
		...
		$result['dbms_version'] = phpbb::$db->sql_server_info(true);
