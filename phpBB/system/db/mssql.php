...
class dbal_mssql extends dbal
{
	...
	*/
	function sql_server_info($raw = false, $use_cache = true)
	{
		...
		if (!$use_cache || empty($cache) || ($this->sql_server_version = phpbb::$cache->get('mssql_version')) === false)
		{
			...
			{
				phpbb::$cache->put('mssql_version', $this->sql_server_version);
			}
		}
	...
	* @access private
	*/
	private function _sql_transaction($status = 'begin')
	{
		switch ($status)
		{
			case 'begin':
