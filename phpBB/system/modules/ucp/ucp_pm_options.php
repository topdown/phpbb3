...
function message_options($id, $mode, $global_privmsgs_rules, $global_rule_conditions)
{
	...
	$redirect_url = append_sid(phpbb::$phpbb_root_path . "ucp." . phpbb::$phpEx, "i=pm&amp;mode=options");
	...
	if (isset($_POST['addfolder']))
	{
		if (check_form_key('ucp_pm_options'))
		{
			...
			{
				$msg = phpbb::$user->lang['FOLDER_NAME_EMPTY'];
			}
		}
		else
		{
	...
	if (isset($_POST['remove_folder']))
	{
		...
		if (confirm_box(true))
		{
			...
			$meta_info = append_sid(phpbb::$phpbb_root_path . "ucp." . phpbb::$phpEx, "i=pm&amp;mode=$mode");
	...
	if (isset($_POST['delete_rule']) && !isset($_POST['cancel']))
	{
		...
		if (!$delete_id)
		{
			redirect(append_sid(phpbb::$phpbb_root_path . "ucp." . phpbb::$phpEx, 'i=pm&amp;mode=' . $mode));
		}
	...
	phpbb::$template->assign_vars(array(
		...
		'U_FIND_USERNAME'		=> append_sid(phpbb::$phpbb_root_path . "memberlist." . phpbb::$phpEx, 'mode=searchuser&amp;form=ucp&amp;field=rule_string&amp;select_single=true'),
	));
