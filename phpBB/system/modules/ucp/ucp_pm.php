		...
		switch ($mode)
		{
			...
			case 'popup':
				...
				phpbb::$template->assign_vars(array(
					...
					'S_NOT_LOGGED_IN'	=> (phpbb::$user->data['user_id'] == ANONYMOUS) ? true : false,
					'CLICK_TO_VIEW'		=> sprintf(phpbb::$user->lang['CLICK_VIEW_PRIVMSG'], '<a href="' . append_sid(phpbb::$phpbb_root_path . "ucp." . phpbb::$phpEx, 'i=pm&amp;folder=inbox') . '" onclick="jump_to_inbox(this.href); return false;">', '</a>'),
					'U_INBOX'			=> append_sid(phpbb::$phpbb_root_path . "ucp." . phpbb::$phpEx, 'i=pm&amp;folder=inbox'),
					'UA_INBOX'			=> append_sid(phpbb::$phpbb_root_path . "ucp." . phpbb::$phpEx, 'i=pm&folder=inbox', false))
				);
			...
			case 'compose':
				...
				$user_folders = get_folder(phpbb::$user->data['user_id']);
				...
				include(phpbb::$phpbb_root_path . '/system/modules/ucp/ucp_pm_compose.' . phpbb::$phpEx);
			...
			case 'options':
				...
				include(phpbb::$phpbb_root_path . '/system/modules/ucp/ucp_pm_options.' . phpbb::$phpEx);
			...
			case 'drafts':
				...
				include(phpbb::$phpbb_root_path . '/system/modules/ucp/ucp_main.' . phpbb::$phpEx);
			...
			case 'view':
				...
				if (!phpbb::$auth->acl_get('u_readpm'))
				{
				...
				{
					include(phpbb::$phpbb_root_path . '/system/modules/ucp/ucp_pm_viewfolder.' . phpbb::$phpEx);
				...
				else if ($action == 'view_message')
				{
					...
					include(phpbb::$phpbb_root_path . '/system/modules/ucp/ucp_pm_viewmessage.' . phpbb::$phpEx);
