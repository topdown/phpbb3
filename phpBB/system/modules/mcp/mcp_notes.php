...
class mcp_notes
{
		...
		switch ($mode)
		{
			case 'front':
				phpbb::$template->assign_vars(array(
					...
					'U_POST_ACTION'		=> append_sid(phpbb::$phpbb_root_path . "mcp." . phpbb::$phpEx, 'i=notes&amp;mode=user_notes'),
	...
	*/
	function mcp_notes_user_view($action)
	{
		...
		$log_data = array();
		$log_count = 0;
		view_log('user', $log_data, $log_count, phpbb::$config['topics_per_page'], $start, 0, 0, $user_id, $sql_where, $sql_sort, $keywords);
		...
		phpbb::$template->assign_vars(array(
			...
			'PAGINATION'		=> generate_pagination($this->u_action . "&amp;$u_sort_param$keywords_param", $log_count, phpbb::$config['topics_per_page'], $start),
