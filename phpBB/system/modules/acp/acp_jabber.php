...
class acp_jabber
{
	...
	function main($id, $mode)
	{
		...
		include_once(phpbb::$phpbb_root_path . 'system/core/jabber.' . phpbb::$phpEx);
		...
		$jab_enable			= request_var('jab_enable',			(bool)		phpbb::$config['jab_enable']);
		$jab_host			= request_var('jab_host',			(string)	phpbb::$config['jab_host']);
		$jab_port			= request_var('jab_port',			(int)		phpbb::$config['jab_port']);
		$jab_username		= request_var('jab_username',		(string)	phpbb::$config['jab_username']);
		$jab_password		= request_var('jab_password',		(string)	phpbb::$config['jab_password']);
		$jab_package_size	= request_var('jab_package_size',	(int)		phpbb::$config['jab_package_size']);
		$jab_use_ssl		= request_var('jab_use_ssl',		(bool)		phpbb::$config['jab_use_ssl']);
