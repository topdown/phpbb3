...
class acp_logs
{
	...
	function main($id, $mode)
	{
		...
		$log_data = array();
		$log_count = 0;
		view_log($mode, $log_data, $log_count, phpbb::$config['topics_per_page'], $start, $forum_id, 0, 0, $sql_where, $sql_sort, $keywords);
		...
		phpbb::$template->assign_vars(array(
			...
			'PAGINATION'	=> generate_pagination($this->u_action . "&amp;$u_sort_param$keywords_param", $log_count, phpbb::$config['topics_per_page'], $start, true),
