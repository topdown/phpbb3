	...
	function main($id, $mode)
	{
		...
		if ($submit)
		{
			...
			if (!sizeof($error))
			{
				...
				{
					$message = sprintf(phpbb::$user->lang['EMAIL_SEND_ERROR'], '<a href="' . append_sid("{$phpbb_admin_path}index." . phpbb::$phpEx, 'i=logs&amp;mode=critical') . '">', '</a>');
		...
		phpbb::$template->assign_vars(array(
			...
			'USERNAMES'				=> $usernames,
			'U_FIND_USERNAME'		=> append_sid(phpbb::$phpbb_root_path . "memberlist." . phpbb::$phpEx, 'mode=searchuser&amp;form=acp_email&amp;field=usernames'),
			'SUBJECT'				=> $subject,
			'MESSAGE'				=> $message,
