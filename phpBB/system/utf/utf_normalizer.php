	...
	*/
	function cleanup(&$str)
	{
		...
		if (!isset($GLOBALS['utf_nfc_qc']))
		{
			...
			include(phpbb::$phpbb_root_path . 'system/utf/data/utf_nfc_qc.' . phpbb::$phpEx);
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{

			include(phpbb::$phpbb_root_path . 'system/utf/data/utf_canonical_decomp.' . phpbb::$phpEx);
		}
	...
	*/
	function nfkc(&$str)
	{
		...
		if (!isset($GLOBALS['utf_nfkc_qc']))
		{
			...
			include(phpbb::$phpbb_root_path . 'system/utf/data/utf_nfkc_qc.' . phpbb::$phpEx);
		}

		if (!isset($GLOBALS['utf_compatibility_decomp']))
		{

			include(phpbb::$phpbb_root_path . 'system/utf/data/utf_compatibility_decomp.' . phpbb::$phpEx);
		}
	...
	*/
	function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		if (!isset($utf_jamo_index, $utf_jamo_type, $utf_combining_class))
		{
			...
			include(phpbb::$phpbb_root_path . 'system/utf/data/utf_normalizer_common.' . phpbb::$phpEx);
		}
		...
		if (!isset($utf_canonical_comp))
		{
			...
			include(phpbb::$phpbb_root_path . 'system/utf/data/utf_canonical_comp.' . phpbb::$phpEx);
		}
